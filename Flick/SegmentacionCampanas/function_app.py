    ...
    if resultado.total_clientes == 0:
        return func.HttpResponse(
            json.dumps({
                ...
                "municipios_no_reconocidos_total": resultado.municipios_no_reconocidos_total,
                "municipios_no_reconocidos_resumen": resultado.municipios_no_reconocidos_resumen,
            }),
            status_code=200,
